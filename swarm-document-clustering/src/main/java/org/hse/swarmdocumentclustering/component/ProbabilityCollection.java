package org.hse.swarmdocumentclustering.component;
...
public class ProbabilityCollection<E> {
    ...
    private final NavigableSet<ProbabilityCollection.ProbabilitySetElement<E>> collection;
    private final SplittableRandom random = new SplittableRandom();

    private long totalProbability;

    public ProbabilityCollection() {
        this.collection = new TreeSet<>(Comparator.comparingLong(ProbabilityCollection.ProbabilitySetElement::getIndex));
    ...
    public Iterator<ProbabilityCollection.ProbabilitySetElement<E>> iterator() {
    ...
    public void add(E object, long probability) {
        ...
        ProbabilityCollection.ProbabilitySetElement<E> entry = new ProbabilityCollection.ProbabilitySetElement<E>(object, probability);
    ...
    public boolean remove(E object) {
        ...
        Iterator<ProbabilityCollection.ProbabilitySetElement<E>> it = this.iterator();
        boolean removed = false;

        while (it.hasNext()) {
            ProbabilityCollection.ProbabilitySetElement<E> entry = it.next();
    ...
    public E get() {
        ...
        ProbabilityCollection.ProbabilitySetElement<E> toFind = new ProbabilityCollection.ProbabilitySetElement<>(null, 0);
    ...
    private final void updateIndexes() {
        ...
        for (ProbabilityCollection.ProbabilitySetElement<E> entry : this.collection) {
